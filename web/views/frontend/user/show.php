...
<div class="row">
   <div class="col-sm-12 text-center">
        <a href="<?php echo base_url('user');?>" class="btn btn-default btn-md"><?php echo $this->lang->line('btn_back'); ?></a>
        <a href="<?php echo base_url('user/edit/'.$row['id']);?>" class="btn btn-warning btn-md"><?php echo $this->lang->line('btn_edit'); ?></a>
