        ...
        <table class="table table-striped table-hover table-bordered">
            <thead>
                <tr>
                    ...
                    <th><a href="<?php echo base_url('acp/whisper/add');?>" class="btn btn-success btn-sm"><?php echo $this->lang->line('btn_add'); ?></a></th>
                </tr>
            </thead>
            <tbody>
            <?php
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <button class="btn btn-danger btn-xs" onclick="delete_confirm('Delete Whisper', 'Are you sure?', 'acp/whisper/delete/<?php echo $row['id'];?>')">
