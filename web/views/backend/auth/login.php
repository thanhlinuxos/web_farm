                    ...
                    <div class="panel-body" >
                        <form name="form" id="form" class="form-horizontal" method="POST" autocomplete="off">
                            <div class="input-group <?php if(form_error('u')) echo 'has-error'; ?>">
                                ...
                                <input id="user" type="text" class="form-control" name="u" value="<?php echo set_value('u')?>" placeholder="User">
                            </div>
                            <div class="input-group <?php if(form_error('p')) echo 'has-error'; ?>">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                                <input id="password" type="password" class="form-control" name="p" value="<?php echo set_value('p')?>" placeholder="Password">
                            </div>                                                                  
